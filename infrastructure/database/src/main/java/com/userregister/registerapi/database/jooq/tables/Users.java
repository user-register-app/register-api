 ...
 */
package com.userregister.registerapi.database.jooq.tables;


import com.userregister.registerapi.database.jooq.Public;
...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, LocalDateTime> TIMESTAMP = createField(DSL.name("timestamp"), SQLDataType.LOCALDATETIME(6), this, "");
